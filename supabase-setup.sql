-- ============================================================
-- ABARROTES ELEUTERIO — Script Supabase (PostgreSQL)
-- Ejecutar manualmente en: Supabase → SQL Editor → New query
-- ============================================================

CREATE EXTENSION IF NOT EXISTS "pgcrypto";

-- Limpieza opcional (descomentar solo en proyecto nuevo)
-- DROP TABLE IF EXISTS item_orden_proveedor CASCADE;
-- DROP TABLE IF EXISTS orden_proveedor CASCADE;
...
-- Columna rol para proyectos existentes
ALTER TABLE usuario ADD COLUMN IF NOT EXISTS rol VARCHAR(50) NOT NULL DEFAULT 'ROLE_ADMIN';
...
-- RLS (Spring Boot se conecta con usuario postgres directo)
...
-- ============================================================
-- NOTA: El usuario Don Eleuterio se crea automáticamente
-- al iniciar Spring Boot (DataInitializer).
-- Credenciales por defecto:
--   Email: eleuterio@abarrotes.com
--   Password: Eleuterio2024!
-- ============================================================
